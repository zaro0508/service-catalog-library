...
ESTR=$((aws cloudformation update-stack --stack-name $StackName --parameters '[{"ParameterKey":"ChildAccountAccess","UsePreviousValue":true},{"ParameterKey":"RandomString","UsePreviousValue":true},{"ParameterKey":"CodeCommitRepoName","UsePreviousValue":true},{"ParameterKey":"pipelineartifactsBucketName","UsePreviousValue":true},{"ParameterKey":"DeployedTemplatesBucketName","UsePreviousValue":true}]' --template-url "${S3Https}/codepipeline/sc-codepipeline-ra-ct-multi.yaml" --capabilities CAPABILITY_IAM CAPABILITY_NAMED_IAM CAPABILITY_AUTO_EXPAND) 2>&1)
ECODE=$?
